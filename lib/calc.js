...
function calc (type, format, diskSize, hideSize = 0) {
  if (!diskSize || typeof diskSize !== 'number' || diskSize <= 0) {
    throw new TypeError('"diskSize" argument must be a positive number: ' + diskSize)
  }
//  if (!hideSize || typeof hideSize !== 'number' || hideSize < 0) {
//    throw new TypeError('"hideSize" argument must be a non-negative number: ' + hideSize)
//  }
